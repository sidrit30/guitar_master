...
if (isset($_POST['upload_picture'])) {
    ...
    if (empty($file["name"])) {
        $target_file =  "uploads/profile/profile_default.png";
    }
    ...
    $newfilename = uniqid() . "admin" . $extension;
    ...
    if ($_FILES['profile_picture']["size"] > 10485760) {
        $errors[] = "Profile picture must be less than 10MB.";
    }

    if (!move_uploaded_file($_FILES['profile_picture']["tmp_name"], dirname(__DIR__) . DIRECTORY_SEPARATOR . $target_file)) {
